...
class HexInt : HexNumber<Int, HexInt> {
    ...
    constructor(hex: String) : super(hex, { hex.removePrefix("0x").ifBlank { "0" }.toInt(16) })
...
class HexULong : HexNumber<ULong, HexULong> {
    ...
    constructor(hex: String) : super(hex, { hex.removePrefix("0x").ifBlank { "0" }.toULong(16) })
    ...
    operator fun inc(): HexULong = HexULong(number + 1u)
...
class HexBigInt : HexNumber<BigInteger, HexBigInt> {
    ...
    constructor(hex: String) : super(hex, { hex.removePrefix("0x").ifBlank { "0" }.toBigInteger(16) })
