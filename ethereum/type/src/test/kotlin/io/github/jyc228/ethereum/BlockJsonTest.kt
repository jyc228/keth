...
class BlockJsonTest : StringSpec({
    "decode block no tx" {
        ...
        block.hash.hex shouldBe "0xb4bc78f3a7c239836325b3fc2f12ff788fee0180caa86e82afd4f3887230e168".lowercase()
    ...
    "decode uncle block" {
        ...
        block.stateRoot.hex shouldBe "0xa18dcb578ea2c1d80999c09879550ccb11e86cebe6824c18d3b0981166481be0".lowercase()
    }
})
